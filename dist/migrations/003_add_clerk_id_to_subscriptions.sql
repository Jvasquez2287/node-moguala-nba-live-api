...
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE name = 'idx_subscriptions_clerk_id' AND object_id = OBJECT_ID('[dbo].[subscriptions]'))
BEGIN
    CREATE INDEX idx_subscriptions_clerk_id ON [dbo].[subscriptions](clerk_id);
