...
exports.playerGameLogResponseSchema = exports.playerGameLogEntrySchema = void 0;
const Joi = __importStar(require("joi"));
// Joi validation schemas
exports.playerGameLogEntrySchema = Joi.object({
...
exports.playerGameLogResponseSchema = Joi.object({
    player_id: Joi.number().integer().required(),
    season: Joi.string().required(),
    games: Joi.array().items(exports.playerGameLogEntrySchema).required(),
});
//# sourceMappingURL=playergamelog.js.map