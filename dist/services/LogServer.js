...
class LogServerManager {
    constructor() {
        ...
        this.DEBUG_USERNAME = process.env.LOG_SERVER_USERNAME || 'debug';
        this.DEBUG_PASSWORD = process.env.LOG_SERVER_PASSWORD || 'password';
    }
    /**
     ...
     */
    sendDebugMessage(category, message, data) {
...
exports.logServer = new LogServerManager();
