...
// ============================================================================
const createMockPlayByPlay = (gameId) => {
    const plays = [
        {
            action_number: 1,
            clock: '12:00',
...
exports.createMockPlayByPlay = createMockPlayByPlay;
// ============================================================================
// MOCK BOX SCORE DATA
// ============================================================================
const createMockBoxScore = (gameId) => {
    const homeTeam = {
        team_id: 1610612738,
...
exports.createMockBoxScore = createMockBoxScore;
// ============================================================================
// MOCK GAME LEADERS
// ============================================================================
const createMockGameLeaders = () => {
    return {
        homeLeaders: {
            personId: 2544951,
            name: 'Jayson Tatum',
...
exports.createMockLiveGames = createMockLiveGames;
// ============================================================================
// MOCK SCOREBOARD
// ============================================================================
const createMockScoreboard = () => {
    const gameDate = new Date().toISOString().split('T')[0];
    return {
        gameDate,
        games: (0, exports.createMockLiveGames)(gameDate)
    };
};
exports.createMockScoreboard = createMockScoreboard;
// ============================================================================
// MOCK KEY MOMENTS
// ============================================================================
const createMockKeyMoments = (gameId) => {
    const moments = [
        {
            type: 'big_shot',
            play: {
...
exports.createMockKeyMoments = createMockKeyMoments;
// ============================================================================
// MOCK WIN PROBABILITY
// ============================================================================
const createMockWinProbability = (gameId) => {
    return {
        game_id: gameId,
        win_probability: {
            home_win_prob: 0.658,
...
exports.createMockWinProbability = createMockWinProbability;
// ============================================================================
// EXPORT ALL MOCK DATA GENERATOR FUNCTIONS
// ============================================================================
exports.default = {
    mockTeams: exports.mockTeams,
    mockPlayers: exports.mockPlayers,
    createMockPlayByPlay: exports.createMockPlayByPlay,
    createMockBoxScore: exports.createMockBoxScore,
    createMockGameLeaders: exports.createMockGameLeaders,
    createMockLiveGames: exports.createMockLiveGames,
    createMockScoreboard: exports.createMockScoreboard,
    createMockKeyMoments: exports.createMockKeyMoments,
    createMockWinProbability: exports.createMockWinProbability
};
