...
exports.failBackServices = void 0;
/**
 ...
 */
const dailyLineupsUrl = (date) => `https://stats.nba.com/js/data/leaders/00_daily_lineups_${date}.json`;
...
const playByPlayUrl = (gameId) => `https://cdn.nba.com/static/json/liveData/playbyplay/playbyplay_${gameId}.json`;
const boxScoreUrl = (gameId) => `https://cdn.nba.com/static/json/liveData/boxscore/boxscore_${gameId}.json`;
const playoffPictureUrl = (seasonYear, state) => `https://stats.nba.com/stats/playoffbracket?LeagueID=00&SeasonYear=${seasonYear}&State=${state}`;
...
exports.failBackServices = {
    fetchDailyLineups: (date) => fetchData(dailyLineupsUrl(date)),
    ...
    fetchPlayByPlay: (gameId) => fetchData(playByPlayUrl(gameId)),
    fetchBoxScore: (gameId) => fetchData(boxScoreUrl(gameId)),
    fetchPlayoffPicture: (seasonYear, state) => fetchData(playoffPictureUrl(seasonYear, state)),
};
//# sourceMappingURL=failBackServices.js.map