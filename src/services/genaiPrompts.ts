 ...
 */
export function getGenaiSystemMessage(): string {
  return (
 ...
 */
export function buildGenaiInsightPrompt(options: {
  homeTeamName: string;
  awayTeamName: string;
  ...
  const winningTeamByScore =
    predictedHomeScore > predictedAwayScore ? homeTeamName : awayTeamName;
 ...
 */
export function getLiveGameSystemMessage(): string {
  return (
 ...
 */
export function buildLiveGameInsightPrompt(options: {
  homeTeam: string;
  awayTeam: string;
  homeScore: number;
  awayScore: number;
  ...
  const playsText =
    lastThreePlays && lastThreePlays.length > 0
 ...
 */
export function getGenaiBatchedInsightsSystemMessage(): string {
  return (
 ...
 */
export function buildGenaiBatchedInsightsPrompt(
 ...
 */
export function getKeyMomentSystemMessage(): string {
  return (
 ...
 */
export function buildKeyMomentContextPrompt(options: {
  momentType: string;
  gameInfo: {
    homeTeam: string;
    awayTeam: string;
 ...
 */
export function getBatchedMomentContextSystemMessage(): string {
  return (
 ...
 */
export function buildBatchedMomentContextPrompt(
  momentsWithGameInfo: Array<{
    momentId: string;
    moment: { type: string; play: Record<string, any> };
    gameInfo: {
      homeTeam: string;
      awayTeam: string;
      homeScore: number;
  ...
  const momentsData = momentsWithGameInfo.map((item) => {
    ...
    const scoreDiff = Math.abs(gameInfo.homeScore - gameInfo.awayScore);
    const leadingTeam =
      gameInfo.homeScore > gameInfo.awayScore ? gameInfo.homeTeam : gameInfo.awayTeam;
    const momentDescription = typeDescriptions[momentType] || 'An important game moment';
